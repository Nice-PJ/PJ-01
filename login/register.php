        ...
        <div class="row px-3">
            <div class="col-lg-10 col-xl-9 card flex-row mx-auto px-0">
                ...
                <div class="card-body">
                    ...
                    <form action="register_db.php" method="post" class="form-box px-3">
                        ...
                        <div class="mb-3">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="cb1" onclick="showpass()">
                                <label class="custom-control-label" for="cb1">Show Password</label>
                            </div>
                        </div>

                        <div class="mb-3">
                            <button type="submit" name="signup" class="w-100 btn btn-block text-uppercase">
                                Register
                            </button>
                        </div>
                        <div class="mb-3">
